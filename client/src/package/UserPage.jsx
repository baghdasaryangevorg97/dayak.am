...
import DefPhoto from '../../src/assets/img/defPhoto.jpg'
...
let data = {};
data.title = job;
data.description = jobD
}
useEffect(() => {
  axios.post(API_BASE_URL + '/api/addExperience', null, getAxiosConfig())
})
                    ...
                    <div className="card">
                      <div className="rounded-top text-white d-flex flex-row " style={{ backgroundColor: '#000', height: '200px' }}>
                        <div className="ms-4 mt-5 d-flex flex-column" style={{ width: '150px' }}>
                          <div>
                            {
                              <img key={userInfo.photo} src={userInfo.photo === undefined ? PhotoLoader : userInfo.photo != 'NULL' ? API_BASE_URL + '/images/' + userInfo.photo : DefPhoto} className="img-fluid img-thumbnail mt-4 mb-2" style={{ width: '150px', height: '160px' }} />
                            }
                          </div>
                          <EditPhoto />
                      ...
                      <div className="card-body p-4 text-black">
                        ...
                        <div className="mb-5">
                          ...
                          <div className="p-4" style={{ backgroundColor: '#f8f9fa' }}>
                            ...
                            <input onChange={(e) => setJob(e.target.value)}/> <br></br>
                            <label>Job description</label>
                            <input onChange={(e) => setJobD(e.target.value)}/><br></br>
